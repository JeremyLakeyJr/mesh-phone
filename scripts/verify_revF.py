...
original=footprints(base/'hardware/main/mesh-phone.kicad_pcb')
revision=footprints(d/'mesh-phone.kicad_pcb')
...
summary={
 ...
 'sha256':{f:hashlib.sha256((d/f).read_bytes()).hexdigest() for f in ['mesh-phone.kicad_pcb','mesh-phone.kicad_sch','gps-expansion.kicad_sch','mesh-phone.kicad_pro','netlist.xml']},
 'checks':checks,
}
