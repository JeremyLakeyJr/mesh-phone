...
Open `owasso1.kicad_pro` in this directory. It is a separate engineering revision;
the original project is one directory above. See the electrical review in
`../review-2026-09-20/CONNECTION_REVIEW.md` before powering or ordering anything.
...
card-edge dock. Enclosure retention and connector access remain to be modeled.
...
`gpio_table.md` for these signals only. Remaining one-pin interface nets are
